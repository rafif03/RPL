        ...
        <header class="bg-body py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <img src="assets/bangi.png" alt="Banner GI" class="img-fluid img-thumbnail">
                </div>
            </div>
        </header>

        <h1 class="text-center text-weight-bold text-white">Top Up Genshin Impact</h1>
        <!-- Section-->
        <section class="py-5">
            <form class="pd-form" method="post">
                <div class="container px-4 px-lg-5 mt-5">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>
                                <input type="radio" value="17" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>60 Genesis Crystals</h4></div>
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" value="18" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>Blessing of the Welkin Moon</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 60.048,-
                                    </div>
                                  </div>
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" value="19" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>330 Genesis Crystals</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 60.048,-
                                    </div>
                                  </div>
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" value="20" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>1090 Genesis Crystals</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 180.036,-
                                    </div>
                                  </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>
                                <input type="radio" value="21" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>3880 Genesis Crystals</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 599.940,-
                                    </div>
                                  </div>
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" value="22" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>8080 Genesis Crystals</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 1.199.880,-
                                    </div>
                                  </div>
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" value="23" name="product" class="card-input-element" />
                                  <div class="card card-input">
                                    <div class="card-img-top"><img width="186" height="180" src="assets/crystal.png"></div>
                                    <div class="card-header text-center"><h4>All Pack Genesis Crystall</h4></div>
                                    <div class="card-body text-center">
                                      Rp. 2.441.722,-
                                    </div>
                                  </div>
...
function insert($data){
    ...
    $query = "INSERT INTO game(game, nick, IDUser, Server, IDItem, metode, mobile, email, Status) VALUES ('Genshin Impact', '$Nick', '$ID', '$Server', '$Product', '$Method', '$HP', '$Email', 'Pending')";
