        ...
        <header class="bg-body py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Kontak CS</h1>
                </div>
            </div>
        </header>
        <!--Body-->
        <a class="navbar-brand" href="https://wa.me/082138562787"><img
            src="assets/whatsapp.png"
            alt="Whatsapp" width=80>
        <h3 class="m-0 text-white">Whatsapp</h3></a>
        <a class="navbar-brand" href="https://www.instagram.com/vann.storee_/?hl=cs"><img
            src="assets/ig.png"
            alt="Instagram" width=80></a>
        <h3 class="m-0 text-white">Instagram</h3></a>
        <!-- Footer-->
