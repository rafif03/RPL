        ...
        <header class="bg-body py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <img src="assets/banpubg.png" alt="Banner GI" class="img-fluid img-thumbnail">
                </div>
            </div>
        </header>
...
function insert($data){
    ...
    $query = "INSERT INTO game(game, nick, IDUser, Server, IDItem, metode, mobile, email, Status) VALUES ('PUBG Mobile', '$Nick', '$ID', '$Server', '$Product', '$Method', '$HP', '$Email', 'Pending')";
